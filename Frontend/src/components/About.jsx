  ...
  return (
    <>
      ...
      <div className="w-full max-w-6xl mx-auto text-center mb-12">
        <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-6">About ProctorMate</h1>
      ...
      {/* Our Mission Section */}
      <div className="w-full max-w-6xl bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8 mb-12 transition-transform transform hover:scale-105 duration-300">
      ...
      <div className="w-full max-w-6xl mb-12">
        <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-6 text-center">Meet the Team</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Team Member 1 */}
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg text-center transition-transform transform hover:scale-105 duration-300">
            <img
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg text-center transition-transform transform hover:scale-105 duration-300">
            <img
              ...
              alt="Emily Johnson"
            />
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Emily Johnson</h3>
      ...
      <div className="w-full max-w-6xl bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8 mb-12 transition-transform transform hover:scale-105 duration-300">
        ...
        <ul className="text-gray-600 dark:text-gray-300 text-lg list-disc pl-5">
