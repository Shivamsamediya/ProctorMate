      ...
      <div className="w-full max-w-4xl bg-white shadow-md rounded-lg p-8 flex flex-col lg:flex-row space-y-6 lg:space-y-0 lg:space-x-10">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <form className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            >
              Send Message
            </button>
          </form>
