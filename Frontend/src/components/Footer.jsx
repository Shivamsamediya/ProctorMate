  ...
  return (
    ...
    <footer className="footer footer-center p-10 bg-base-100 text-base-content rounded  dark:bg-slate-900 dark:text-white">
        <nav className="grid grid-flow-col gap-4">
            ...
            <a href='/report' className="btn decoration-transparent transition-all duration-300 transform hover:scale-105">Report a bug</a>
        </nav> 
        <nav>
            <div className="grid grid-flow-col gap-8">
                <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current transition-all duration-300 transform hover:scale-105">
        ...
        <aside>
            <p>Copyright © 2024 - All right reserved  by ProctorMate</p>
        </aside>
    </footer>
    <hr />
    </>
